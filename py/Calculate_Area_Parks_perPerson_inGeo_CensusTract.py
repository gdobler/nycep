...
geos = gp.GeoDataFrame.from_file('NYC_Raw/Census_Tracts_Clipped.shp')
population = 'C:\NYU\GRA\Data\Raw\Population_Data\CensusTracts\ACS_12_5YR_B01003_with_ann.csv'
Output = 'C:\NYU\GRA\Data\Output_Shapefiles\CensusTracts_Pop_Fraction'
